...
void Cube::spinR(){
	...
	cubeArr[5].getFace()[0][2] = cubeArr[3].getFace()[0][0];
	cubeArr[5].getFace()[1][2] = cubeArr[3].getFace()[1][0];
	cubeArr[5].getFace()[2][2] = cubeArr[3].getFace()[2][0];
...
void Cube::spinRi(){
	...
	temp1 = cubeArr[0].getFace()[1][2];
	temp2 = cubeArr[0].getFace()[2][2];
	cubeArr[0].getFace()[0][2] = cubeArr[3].getFace()[0][0];
	cubeArr[0].getFace()[1][2] = cubeArr[3].getFace()[1][0];
	cubeArr[0].getFace()[2][2] = cubeArr[3].getFace()[2][0];
	cubeArr[3].getFace()[0][0] = cubeArr[5].getFace()[0][2];
	cubeArr[3].getFace()[1][0] = cubeArr[5].getFace()[1][2];
	cubeArr[3].getFace()[2][0] = cubeArr[5].getFace()[2][2];
...
void Cube::spinLi(){
	...
	cubeArr[5].getFace()[0][0] = cubeArr[3].getFace()[0][2];
	cubeArr[5].getFace()[1][0] = cubeArr[3].getFace()[1][2];
	cubeArr[5].getFace()[2][0] = cubeArr[3].getFace()[2][2];
...
void Cube::spinL(){
	...
	temp1 = cubeArr[0].getFace()[1][0];
	temp2 = cubeArr[0].getFace()[2][0];
	cubeArr[0].getFace()[0][0] = cubeArr[3].getFace()[0][2];
	cubeArr[0].getFace()[1][0] = cubeArr[3].getFace()[1][2];
	cubeArr[0].getFace()[2][0] = cubeArr[3].getFace()[2][2];
	cubeArr[3].getFace()[0][2] = cubeArr[5].getFace()[0][0];
	cubeArr[3].getFace()[1][2] = cubeArr[5].getFace()[1][0];
	cubeArr[3].getFace()[2][2] = cubeArr[5].getFace()[2][0];
